    ...
    builder: (context, snapshot) {
      if (snapshot.connectionState == ConnectionState.waiting) {
        ...
        return FunctionInputTile(
          ...
          newPositionDropdownItems: snapshot.data!, // Use fetched branches
          onSubmit: (values) async {
            if (_formKey.currentState!.validate()) {
              try {
                final editTransferEmployee_Model = await editTransferEmployee(
                  employeeId: widget.employeeId,
                      ...
                      if (widget.attributeNames[idx] == 'oldPhone' &&
                        ...
                        return Padding(
                          ...
                          child: DropdownButtonFormField<String>(
                            ...
                            items: widget.newPositionDropdownItems!.map((branch) {
                              return DropdownMenuItem(
